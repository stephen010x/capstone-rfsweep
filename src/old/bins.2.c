...
// since this is the only function remaining, I should just move this to hackrf
...
// int fbins_array_init(fbins_array_t *fbinsa, int count) {
// 
//     fbinsa->fbins = malloc(count * sizeof(void*));
//     assert(fbinsa->fbins != NULL, -1);
// 
//     fbinsa->count = count;
//     
//     return 0;
...
// 
// 
// void fbins_array_free(fbins_array_t *fbinsa) {
// 
//     // free all fbins in the fbins array
//     for (int i = 0; i < fbinsa->count; i++)
//         free(fbinsa->fbins[i]);
// 
